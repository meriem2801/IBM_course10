...
It demonstrates my ability to go from **data collection** to **machine learning**, including analysis, visualization, and deployment.

---

## What I Did

- Collected launch data via **SpaceX API** and **web scraping**
- Cleaned and prepared datasets for analysis
- Performed **EDA using Python & SQL**
- Built **interactive dashboards** with Dash & Plotly
...
- Visualized launch performance by site and payload
- Built a predictive model to estimate landing success probability
